...
gallery:
  ...
  - src: ../../assets/cases/illoca/02.webp
    alt: Сцена рабочего стола архитектора — чертёж, эскиз и стопка книг, камера ведёт по столу при прокрутке
  - src: ../../assets/cases/illoca/03.webp
    alt: Трёхмерная модель здания на подложке генплана — сцена собирается по мере прокрутки
